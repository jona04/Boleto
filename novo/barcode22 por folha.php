...
if(isset($_POST['inicio']) && isset($_POST['fim'])){
	...
	for ($ii=$inicio;$ii<=$fim;$ii++)
	{
		...
		//$valor = "867000000000000454740000000000000000000".$digitos; // Valor Inicial
		$valor = "867000000000000455634100000000000000000".$digitos; // Valor Inicial
		$vetor21 = "00".$digitos;
		...
		$novo_cod = "867".$quarto_num."0000000".$mod10_primeiroOnze."00000455634100000000000000000".$digitos;
	
		$ultimo_onze = "0000000".$digitos;
		
		$mod10_ultimo_onze = modulo10($ultimo_onze);
		
		//$novo_cod2 = "867".$quarto_num."000000000000454740000000000000000000".$digitos;
		$novo_cod2 = "867".$quarto_num."000000000000455634100000000000000000".$digitos;
...
//Fim da função
	...
	<div id="linha-digitavel"><?php echo "867".$quarto_num."0000000 ".$mod10_primeiroOnze." 00000455634 8 10000000000 0 0000000".$digitos." ".$mod10_ultimo_onze  ?></div>
	<div id="inscricao-aluno"><?php echo "00".$digitos?></div>
